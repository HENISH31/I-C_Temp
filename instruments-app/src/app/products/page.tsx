...
const ALL_PRODUCTS: Product[] = [
    ...
    {
        id: "product-9",
        name: "Silica Gel Breathers (ABS Lids) 2 Kgs",
        category: "Transformer Parts",
        categoryColor: "#FF3B30",
        emoji: "💨",
        image: "/image/Silica gel 2kg.png",
        link: "/contact",
        specs: ["High capacity moisture control", "Transparent ABS body", "Industrial grade", "High volume protection", "Standard threading", "Low maintenance"],
        description: "Large capacity 2 Kg Silica Gel Breather designed for maximum moisture extraction in heavy-duty transformers. Ensures long-lasting protection with a durable ABS enclosure.",
        highlights: ["High Capacity", "Durable ABS Enclosure", "Maximum Protection"],
    },
    {
        id: "product-10",
        name: "Silica Gel Breathers (ABS Lids) 3 Kgs",
        category: "Transformer Parts",
        categoryColor: "#FF3B30",
        emoji: "💨",
        image: "/image/Silica gel 3kg.png",
        link: "/contact",
        specs: ["Extreme capacity", "Robust ABS casing", "Industrial grade", "Extra high volume protection", "Standard threading", "Extended lifespan"],
        description: "Extra large 3 Kg Silica Gel Breather built for extreme moisture extraction in the largest power transformers. Maximum durability and capacity with a robust ABS enclosure.",
        highlights: ["Extreme Capacity", "Robust ABS Enclosure", "Extended Lifespan"],
    },
    {
        id: "product-11",
        name: "Silica Gel Breathers (ABS Lids) 5 Kgs",
        category: "Transformer Parts",
        categoryColor: "#FF3B30",
        emoji: "💨",
        image: "/image/Silica gel 5kg.png",
        link: "/contact",
        specs: ["Ultra-high capacity", "Heavy-duty ABS casing", "Industrial grade", "Massive volume protection", "Standard threading", "Maximum lifespan"],
        description: "Massive 5 Kg Silica Gel Breather designed for ultra-high capacity moisture extraction in massive power transformers. Unmatched durability and capacity with a heavy-duty ABS enclosure.",
        highlights: ["Ultra-High Capacity", "Heavy-Duty ABS Enclosure", "Maximum Lifespan"],
    },
    {
        id: "product-12",
        name: "Silica Gel Breathers (ABS Lids) 6 Kgs",
        category: "Transformer Parts",
        categoryColor: "#FF3B30",
        emoji: "💨",
        image: "/image/silica gel 6kg.png",
        link: "/contact",
        specs: ["Maximum capacity", "Heavy-duty ABS casing", "Industrial grade", "Extra massive volume protection", "Standard threading", "Ultimate lifespan"],
        description: "Our largest 6 Kg Silica Gel Breather designed for ultimate moisture extraction in the largest power transformers. Offers maximum durability and protection with a reinforced ABS enclosure.",
        highlights: ["Maximum Capacity", "Reinforced ABS Enclosure", "Ultimate Lifespan"],
    },
    {
        id: "product-13",
        name: "Silica Gel Breathers (ABS Lids) 8 Kgs",
        category: "Transformer Parts",
        categoryColor: "#FF3B30",
        emoji: "💨",
        image: "/image/8kg.png",
        link: "/contact",
        specs: ["Colossal capacity", "Reinforced ABS casing", "Industrial grade", "Colossal volume protection", "Standard threading", "Unrivaled lifespan"],
        description: "Our monumental 8 Kg Silica Gel Breather engineered for unrivaled moisture extraction in colossal power transformers. Provides unparalleled durability and long-lasting protection with a heavily reinforced ABS enclosure.",
        highlights: ["Colossal Capacity", "Heavily Reinforced ABS", "Unrivaled Lifespan"],
    },
    {
        id: "product-14",
        name: "Silica Gel Breathers (ABS Lids) 10 Kgs",
        category: "Transformer Parts",
        categoryColor: "#FF3B30",
        emoji: "💨",
        image: "/image/10kg.png",
        link: "/contact",
        specs: ["Flagship capacity", "Ultra-reinforced ABS casing", "Industrial grade", "Maximum volume protection", "Standard threading", "Industry-leading lifespan"],
        description: "Our flagship 10 Kg Silica Gel Breather designed for the most demanding power transformers. Unmatched capacity, extended operational lifespan, and an ultra-reinforced ABS enclosure for complete reliability.",
        highlights: ["Flagship Capacity", "Ultra-Reinforced ABS", "Industry-Leading Lifespan"],
    },
];
